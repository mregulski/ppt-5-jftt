...
{
  "$end", "error", "$undefined", "NUM", "NEWLINE", "LEFT", "RIGHT",
  "MINUS", "PLUS", "MULT", "DIV", "MOD", "NEG", "EXP", "$accept", "input",
  "line", "exp", YY_NULLPTR
};
#endif
...
{
      -8,    32,    -8,     1,    -8,    -8,    35,    35,    -8,    10,
      -8,    18,     2,    -8,    35,    35,    35,    35,    35,    35,
      -8,    -7,    -7,     2,     2,     2,     2
};
...
{
      11,    12,    16,    17,    18,    10,    19,     0,    21,    22,
      23,    24,    25,    26,    13,    19,     0,    14,    15,    16,
      17,    18,     0,    19,    20,    14,    15,    16,    17,    18,
       0,    19,     2,     3,     0,     4,     5,     6,     4,     7,
       6,     0,     7
};

static const yytype_int8 yycheck[] =
{
       6,     7,     9,    10,    11,     4,    13,    -1,    14,    15,
      16,    17,    18,    19,     4,    13,    -1,     7,     8,     9,
      10,    11,    -1,    13,     6,     7,     8,     9,    10,    11,
      -1,    13,     0,     1,    -1,     3,     4,     5,     3,     7,
       5,    -1,     7
};
...
{
       0,    15,     0,     1,     3,     4,     5,     7,    16,    17,
       4,    17,    17,     4,     7,     8,     9,    10,    11,    13,
       6,    17,    17,    17,    17,    17,    17
};
